  ...
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-4 text-center space-y-6">
          <Badge variant = "outline" className="bg-green-100 text-green-700">
            Split expenses .Simplify life.
          </Badge>

          <h1 className="gradient-title mx-auto max-w-4xl text-4xl font-bold md:text-7xl">
            The smartest way to split with friends
          </h1>
      ...
      <section id="features" className="bg-gray-50 py-20"> 
        <div className="container mx-auto px-4 md:px-4 text-center">
          ...
          <h2 className="gradient-title mt-2 text-3xl md:text-4xl">
             Everything you need to spilt the expenses
          </h2>
      ...
      <section id="how-it-works" className="bg-gray-50 py-20"> 
        <div className="container mx-auto px-4 md:px-4 text-center">
          ...
          <h2 className="gradient-title mt-2 text-3xl md:text-4xl">
              Splitting expense has never been easier 
          </h2>
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-3">
            {STEPS.map(({ description, label, title}) => (
                <div className="flex flex-col itemsc-center space-y-4" key={title}>
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <h2 className="text-3xl font-extrabold tracking-tight md:text-4xl text-white">
            Ready to simplify expensed sharing?
          </h2>

          <p className="mx-auto mx-w-[600px] text-green-100 md:text-xl/relaxed">
            Join thousand of user who have made splitting expense
            stress-free
          </p>
      ...
      <footer  className="border-t bg-green-100 py-12 text-center text-sm text-muted-foreground">
          Made with 💖 by MG
      </footer>
    </div>
